...
const base =
  "group relative inline-flex items-center justify-center gap-2 overflow-hidden rounded-xl font-semibold tracking-wide " +
  ...
  function Button(
    ...
    return (
      ...
      >
        ...
        <span
          aria-hidden
          className="pointer-events-none absolute inset-y-0 -left-1/3 w-1/3 -translate-x-[160%] -skew-x-12 bg-gradient-to-r from-transparent via-white/35 to-transparent transition-transform duration-700 ease-out group-hover:translate-x-[420%] motion-reduce:hidden"
        />
